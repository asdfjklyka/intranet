      ...
      <section class="content">
        ...
        <div class="card" style="width: 80%;  box-shadow: 0 0 5px 1px #ccc; margin: auto;">
          ...
          <div class="card-body" >
            ...
            <form>
              <h3 style="margin-top: 5px;">Seminar 5</h3>
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addtitle">Title :</label>
                  <input type="txtCharacter" class="form-control" id="addtitle" placeholder="Enter your Title" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                </div>
                <div class="form-group col-md-12">
                  <label for="addplace">Place:</label>
                  <input type="txtCharacter" class="form-control" id="addplace" placeholder="Enter your Place" aria-describedby="addaddressHelp" required="" onkeypress="return isNumericKey(event)">
                </div>
                ...
                <div class="form-group col-md-6">
                  <label for="adddegree">Organized By:</label>
              ...
              <h3 style="margin-top: 5px;">Reference No. 1</h3>
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addname">Name :</label>
                  <input type="txtCharacter" class="form-control" id="addname" placeholder="Enter your Name" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                </div>
                <div class="form-group col-md-4">
                  <label for="addplace">Title:</label>
                  <input type="txtCharacter" class="form-control" id="addplace" placeholder="Enter your Title" aria-describedby="addaddressHelp" required="" onkeypress="return isNumericKey(event)">
                </div>
                <div class="form-group col-md-4">
                  <label for="addcompany">Company:</label>
                  <input type="txtCharacter" class="form-control" id="addcompany" placeholder="Enter your Company" aria-describedby="addaddressHelp" required="" onkeypress="return isNumericKey(event)">
                </div>                
                <div class="form-group col-md-4">
                  <label>Contact: </label>
              ...
              <h3 style="margin-top: 5px;">Reference No. 2</h3>
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addname">Name :</label>
                  <input type="txtCharacter" class="form-control" id="addname" placeholder="Enter your Name" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
            ...
            <div class="row">
              <nav aria-label="... " class="nav-pagination" style="text-align: center;">
                <ul class="pagination text-center">
                  <li class="page-item"><a class="page-link" href="addinformation5.html">Previous</a>
                  ...
                  <li class="page-item"><a class="page-link" href="addinformation2.html">2</a><li>
                    ...
                    <li class="page-item"><a class="page-link" href="addinformation4.html">4</a><li>
                      ...
                      <li class="page-item active"><a class="page-link" href="addinformation6.html">6</a></li>
