            ...
            <form>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addschool1">School 1:</label>
                  <input type="txtCharacter" class="form-control" id="addschool1" placeholder="Enter your School" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-8">
                  <label for="adddegree">Degree/Awards Received:</label>
                  <input type="txtCharacter" class="form-control" id="adddegree" placeholder="Degree/Awards Received" aria-describedby="adddegreeHelp" required="" onkeypress="return isNumericKey(event)">
                </div>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addschool2">School 2:</label>
                  <input type="txtCharacter" class="form-control" id="addschool2" placeholder="Enter your School" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                </div>
                <div class="form-group col-md-12">
                  <label for="addaddress">Address:</label>
                  <input type="txtCharacter" class="form-control" id="addaddress" placeholder="Enter your Address" aria-describedby="addaddressHelp" required="" onkeypress="return isNumericKey(event)">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addschool3">School 3:</label>
                  <input type="txtCharacter" class="form-control" id="addschool3" placeholder="Enter your School" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                </div>
                <div class="form-group col-md-12">
                  <label for="addaddress">Address:</label>
                  <input type="txtCharacter" class="form-control" id="addaddress" placeholder="Enter your Address" aria-describedby="addaddressHelp" required="" onkeypress="return isNumericKey(event)">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addschool4">School 4:</label>
                  <input type="txtCharacter" class="form-control" id="addschool4" placeholder="Enter your School" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                </div>
                <div class="form-group col-md-12">
                  <label for="addaddress">Address:</label>
                  <input type="txtCharacter" class="form-control" id="addaddress" placeholder="Enter your Address" aria-describedby="addaddressHelp" required="" onkeypress="return isNumericKey(event)">
            ...
            <div class="row">
              <nav aria-label="... " class="nav-pagination" style="text-align: center;">
                <ul class="pagination text-center">
                  <li class="page-item"><a class="page-link" href="addinformation2.html">Previous</a>
                  ...
                  <li class="page-item"><a class="page-link" href="addinformation2.html">2</a><li>
                    <li class="page-item active"><a class="page-link" href="addinformation3.html">3</a></li>
                    <li class="page-item"><a class="page-link" href="addinformation4.html">4</a><li>
                      ...
                      <li class="page-item">
                        <a class="page-link" href="addinformation4.html">Next</a>
                      </li>
                    </ul>
                  </nav>
                </div>
