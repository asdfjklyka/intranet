      ...
      <section class="content">
        ...
        <div class="card" style="width: 80%;  box-shadow: 0 0 5px 1px #ccc; margin: auto;">
          ...
          <div class="card-body" >
            ...
            <form>
              <h3 style="margin-top: 5px;">Seminar 1</h3>
              <div class="row">
              ...
              <h3 style="margin-top: 5px;">Seminar 2</h3>
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addtitle">Title :</label>
                  <input type="txtCharacter" class="form-control" id="addtitle" placeholder="Enter your Title" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                ...
                <div class="form-group col-md-6">
                  <label for="addorganized">Organized By:</label>
                  <input type="txtCharacter" class="form-control" id="addorganized" placeholder="Enter your Organized By" aria-describedby="addorganizedHelp" required="" onkeypress="return isNumericKey(event)">
                </div>
                </div>
                <h3 style="margin-top: 5px;">Seminar 3</h3>
                <div class="row">
                  <div class="form-group col-md-12">
                    <label for="addtitle">Title :</label>
                    <input type="txtCharacter" class="form-control" id="addtitle" placeholder="Enter your Title" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
                 ...
                 <h3 style="margin-top: 5px;">Seminar 4</h3>
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="addtitle">Title :</label>
                  <input type="txtCharacter" class="form-control" id="addtitle" placeholder="Enter your Title" aria-describedby="addschool1Help" required="" onkeypress="return isNumericKey(event)">
              ...
              <div class="row">
                <nav aria-label="... " class="nav-pagination" style="text-align: center;">
                  <ul class="pagination text-center">
                    <li class="page-item"><a class="page-link" href="addinformation4.html">Previous</a>
                    ...
                    <li class="page-item"><a class="page-link" href="addinformation2.html">2</a><li>
                      ...
                      <li class="page-item"><a class="page-link" href="addinformation4.html">4</a><li>
                        <li class="page-item active"><a class="page-link" href="addinformation5.html">5</a></li>
                        <li class="page-item"><a class="page-link" href="addinformation6.html">6</a></li>
                        <li class="page-item">
                          <a class="page-link" href="addinformation6.html">Next</a>
                        </li>
                      </ul>
                    </nav>
                  </div>
